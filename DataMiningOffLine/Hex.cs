...
namespace Hexagonal
{
    public class Hex
    {
        ...
        {
            Initialize(Hexagonal.MyMath.ConvertToFloat(x), Hexagonal.MyMath.ConvertToFloat(y), Hexagonal.MyMath.ConvertToFloat(side), orientation);
        }
        ...
        private void CalculateVertices()
        {
            ...
            h = Hexagonal.MyMath.CalculateH(side);
            r = Hexagonal.MyMath.CalculateR(side);
